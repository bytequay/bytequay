...
interface PermissionGrantJpaRepository
        extends JpaRepository<PermissionGrantEntity, Long>
{
    /** Global grants — scope_id is null. */
    List<PermissionGrantEntity> findByScopeKindAndScopeIdIsNull(String scopeKind);
