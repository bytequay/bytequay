...
type Props = {
  ...
  repo: string;
  onBack: () => void;
  /** Navigate into the existing PRs / Issues / Branches / Commits
   *  surfaces when the user clicks a tab on the new shell. R3 will
   *  eventually mount those views inline as sub-tabs; for R2 the
   *  shell is the entry chrome and the existing pages keep their
   *  routes. */
