...
/** Exact callback adapter for Remote observation results. */
public final class RemoteObservationResultDeliveryPort
        implements ExecutionPorts.ResultDeliveryPort
{
    private final RemoteObservationRuntimeCoordinator coordinator;

    public RemoteObservationResultDeliveryPort(
