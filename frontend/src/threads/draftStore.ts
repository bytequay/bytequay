 ...
 * survives component unmount/remount (so typing in a thread's reply
 ...
 *  grow unboundedly as the user works through many threads. */
 ...
 *  back. Switching the key (e.g. opening a different thread) reloads
