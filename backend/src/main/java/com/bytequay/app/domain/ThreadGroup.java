...
/**
 * One user-defined grouping of {@link Thread}s — a "project bucket"
 * like "Trino refactor" or "ByteQuay backend". Tasks can be
 * unassigned ({@code Thread.groupId} is null); a group can exist with
 * zero threads (it just won't appear in derived counts).
 *
