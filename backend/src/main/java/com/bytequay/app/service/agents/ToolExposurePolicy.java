...
public class ToolExposurePolicy
{
    ...
    private static final Set<String> TRUNK = ImmutableSet.of(
    ...
    private static final Set<String> TASK_CORE = ImmutableSet.of(
            "approval_prompt", "ask_user_question", "codegraph_explore", "explore_project",
            "recall_memory", "lookup_memory", "read_workspace_memory", "lookup_term",
    ...
    private static final Set<String> V2_COMMON = ImmutableSet.of(
            "approval_prompt", "ask_user_question", "codegraph_explore", "explore_project",
            "recall_memory", "lookup_memory", "read_workspace_memory", "lookup_term",
            "read_current_repository", "read_task", "read_plan_summary",
            "read_plan_conversation", "read_pr", "read_file");

    private static final Set<String> V2_TASK_BRAIN = union(V2_COMMON, ImmutableSet.of(
            "count_operations", "read_commit_summary", "read_diff_summary",
            "check_test_coverage", "read_stage_metrics", "read_phase_history",
     ...
     */
    private static final Set<String> V2_AUTOMATIC_TASK_BRAIN = ImmutableSet.copyOf(
            V2_TASK_BRAIN.stream()
                    .filter(tool -> !ImmutableSet.of(
                            "approval_prompt", "ask_user_question").contains(tool))
                    .toList());

    private static final Set<String> V2_LOCAL_DEVELOPMENT = union(V2_COMMON, ImmutableSet.of(
    ...
    private static final Set<String> V2_REMOTE_DEVELOPMENT = union(V2_COMMON, ImmutableSet.of(
    ...
    public Set<String> v2Tools(V2Profile profile)
    {
        Set<String> selected = switch (profile) {
            case PLAN_PROTOCOL, CLEANUP -> ImmutableSet.of();
    ...
    private static Set<String> taskTools(StageType stageType)
    {
        ...
        return switch (stageType) {
            ...
            case CLEANUP_STAGE -> ImmutableSet.of();
        };
    }
