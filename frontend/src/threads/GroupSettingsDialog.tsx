...
import type { ThreadGroupDto } from '../types';

type Props = {
  group: ThreadGroupDto;
  /** Threads currently pinned to this group — count is shown in the
   *  delete confirmation so the user knows what they're un-pinning. */
  pinnedTaskCount: number;
  onClose: () => void;
  onSaved: (group: ThreadGroupDto) => void;
        ...
        {confirmDelete ? (
          <div style={dangerZoneStyle}>
            <div style={{ fontSize: 13, color: '#991b1b' }}>
              ...
              {pinnedTaskCount} pinned thread{pinnedTaskCount === 1 ? '' : 's'}{' '}
