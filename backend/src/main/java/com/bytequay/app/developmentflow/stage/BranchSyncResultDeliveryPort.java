...
/** Callback adapter shared by the finite non-Agent branch-sync effects. */
public final class BranchSyncResultDeliveryPort
        implements ExecutionPorts.ResultDeliveryPort
{
    private final BranchSyncRuntimeCoordinator coordinator;

    public BranchSyncResultDeliveryPort(BranchSyncRuntimeCoordinator coordinator)
    {
