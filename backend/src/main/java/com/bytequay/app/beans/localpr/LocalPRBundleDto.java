 ...
 */
public record LocalPRBundleDto(
        LocalPRDto pr,
        List<LocalPRCommitDto> commits,
        List<LocalPRTimelineEventDto> timeline,
        List<LocalPRCheckDto> checks,
        List<LocalPRCommentDto> comments,
