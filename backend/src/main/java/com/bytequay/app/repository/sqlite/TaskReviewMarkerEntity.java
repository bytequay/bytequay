...
@Entity
@Table(name = "task_review_addressed_marker")
class TaskReviewMarkerEntity
{
    @Id
    @Column(name = "task_id")
    private String taskId;

    @Column(name = "last_addressed_review_at")
    @Convert(converter = InstantToTextConverter.class)
    private Instant lastAddressedReviewAt;
    ...
    protected TaskReviewMarkerEntity() {}
    ...
    Instant getLastAddressedReviewAt() { return lastAddressedReviewAt; }
    void setLastAddressedReviewAt(Instant lastAddressedReviewAt) { this.lastAddressedReviewAt = lastAddressedReviewAt; }
}
