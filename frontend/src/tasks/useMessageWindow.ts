...
/** Latest-N messages we render by default. A long-running task can
 ...
 */
export function useMessageWindow(messages: TaskMessageDto[]): MessageWindow {
