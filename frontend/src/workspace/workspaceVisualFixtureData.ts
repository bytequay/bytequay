...
export const visualWorkspaces: WorkspaceCardDto[] = [
  ...
  },
  {
    ...
    repository: {
      ...
      defaultBaseBranch: 'main',
      clonePath: '/Users/chenjian2664/gateway',
      verified: true,
    },
    recentActivity: [
      {
        ...
        status: 'RUNNING',
        itemPath: '#/workspace/workspace-gateway/prs/3415',
      ...
      },
      {
        ...
        status: 'COMPLETED',
        itemPath: '#/workspace/workspace-gateway/branches',
...
export const visualSessions: WorkspaceSessionDto[] = [
  ...
  },
  {
    ...
    stageId: null,
    durableReview: false,
    controls: { pause: false, resume: false, stop: true, restart: false },
    costUsdMilli: 0,
    tokensIn: 0,
    tokensOut: 0,
    stepCursor: 0,
  ...
  },
  {
    ...
    stageId: null,
    durableReview: false,
    controls: { pause: false, resume: false, stop: false, restart: true },
    costUsdMilli: 420,
    tokensIn: 15_000,
    tokensOut: 3_000,
    stepCursor: 2,
...
export const visualDetailPullRequestDetail: PullRequestDetailDto = cast<PullRequestDetailDto>({
  ...
  assignees: [],
  milestone: { title: '9.9-widget-20260517', progressPercent: 64 },
  developmentLinks: [
  ...
  const base: Partial<Bridge> = {
    ...
    getFootprints: async () => ({
      ...
      stops: [
        ...
        {
          surfaceType: 'TASK',
          surfaceId: 'recent-shared-credentials',
          title: 'Add shared-credentials shared co…',
          context: 'gateway',
    ...
    getAgentReview: async () => null,
    getLocalPrBundle: async () => null,
    getPrForRepoPull: async (_owner: string, _repo: string, number: number) =>
      cast({ id: `visual-pr-${number}` }),
    startAgentReview: async () => cast({}),
