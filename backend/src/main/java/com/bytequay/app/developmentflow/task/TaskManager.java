...
/**
 * Sole synchronous writer for V2 Task lifecycle and Task Brain facts.
 * Initial V2 Task creation is deliberately deferred; when added, it must
 * enter through a TaskManager command and this domain-owned Store.
 */
