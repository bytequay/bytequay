...
/** Route-specific delivery boundary for normalized repair commit adoption. */
public final class RemoteRepairCommitAdoptionResultDeliveryPort
        implements ExecutionPorts.ResultDeliveryPort
{
    private final RemoteRepairTurnRuntime runtime;

    public RemoteRepairCommitAdoptionResultDeliveryPort(
    ...
    {
        return runtime.deliverAdoption(owner, expectedFence, rawResult);
    }
}
