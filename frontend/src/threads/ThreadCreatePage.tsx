 ...
 * {@code nav.view === 'thread-create'}, replacing the old modal-based
 * {@code NewTaskDialog}. Layout mirrors
 * {@code docs/mockups/design/threads/thread-create.png}: a centered card
 ...
 * thread's repo via the existing {@code getRepoPulls} /
 * {@code getRepoIssues} bridge methods. New coding threads are spawned
...
export type ThreadCreatePageProps = {
   ...
   *  navigates to the thread list or the thread-detail page. */
...
export default function ThreadCreatePage({
  ...
  const submit = useCallback(async () => {
    ...
    // Initial prompt is optional — the user can start the thread and
      ...
      <div style={cardStyle}>
        ...
        <div style={bodyStyle}>
          <Field label="Type" required>
            <div style={segStyle} role="radiogroup" aria-label="Thread type">
              <SegBtn
                glyph="🛠"
